...
const pizzaArray = () => {
  ...
  pizzas.push(
    new Pizza(
      "Margarita",
      "Basil, Tomatoes, Olive Oil, Dough",
      "Red Sauce",
      "Fresh Mozzarella",
      "$15",
      "margarita.jpg"
  ...
  pizzas.push(
    new Pizza(
      "Pepperoni",
      "Pepperoni, Sauce, Dough, Cheese",
      "Red Sauce",
      "White Cheddar and Mozzarella",
      "$20",
      "pepperoni.jpg"
    )
  );
  pizzas.push(
    new Pizza(
      "Veggie",
      "Veggies, Cheese, Dough, Sauce",
      "Red Sauce",
      "Mozzarella, but whatever you prefer",
      "$15",
      "veggie.jpg"
    )
  );
